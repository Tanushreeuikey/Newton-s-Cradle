...
function setup() {
	...
	bobObject1= new Bobs(200,500,50)
	bobObject2= new Bobs(300,500,50)
	bobObject3= new Bobs(400,500,50)
	bobObject4= new Bobs(500,500,50)
	bobObject5= new Bobs(600,500,50)
...
function keyPressed()
{
  ...
  { 
    ...
    //Matter.Body.applyForce(ball.body,ball.body.position,{x:700,y:100})
  }
}
